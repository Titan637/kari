...
EXEMPTED_USERS = [7163028849,8163493962]
# Configuration
...
def bgmi_command(message):
    ...
    try:
        ...
        support_button.add(InlineKeyboardButton("🙏 Support 🙏", url="https://t.me/TOPTEN_CHEAT"))
...
def send_welcome(message):
    ...
    *_A Powerful DDoS Protection Testing Tool_*
    ...
    markup.add(
        ...
        telebot.types.InlineKeyboardButton("📚 Tutorial", url='https://t.me/TOPTEN_CHEAT')
    )
...
def send_help(message):
    ...
    📌 *Need Help?*
    Contact support: @TOPTEN_CHEAT
    Report issues: @Topten_Kari
    """
    
    # Add support buttons
    markup = telebot.types.InlineKeyboardMarkup()
    markup.add(
        telebot.types.InlineKeyboardButton("🆘 Immediate Support", url='t.me/Topten_Kari'),
        telebot.types.InlineKeyboardButton("📘 Documentation", url='https://t.me/TOPTEN_CHEAT')
    )
